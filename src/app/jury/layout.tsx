...
import { NAV_ITEMS_JURY } from "@/lib/nav-items";
import { IconeTableauDeBord } from "@/components/icons";
...
export default async function JuryLayout({
  ...
  const connecte = await exigerRole(["jury"]);
  const nom = connecte.profil?.nom_complet || connecte.user.email || "Juré";
          ...
          <div className="flex items-center gap-2.5 px-5 py-5">
            ...
            <SidebarLabel>
              <div className="leading-tight">
                ...
                <p className="text-[11px] text-sidebar-fg-muted">Espace jury</p>
              </div>
            </SidebarLabel>
          </div>
